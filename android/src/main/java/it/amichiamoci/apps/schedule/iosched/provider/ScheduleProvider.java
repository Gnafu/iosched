...
package it.amichiamoci.apps.schedule.iosched.provider;

import it.amichiamoci.apps.schedule.iosched.appwidget.ScheduleWidgetProvider;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.Announcements;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.PeopleIveMet;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.Blocks;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.Experts;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.Feedback;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.MapMarkers;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.MapTiles;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.Rooms;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.SearchSuggest;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.Sessions;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.Speakers;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.Tags;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleDatabase.SessionsSearchColumns;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleDatabase.SessionsSpeakers;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleDatabase.Tables;
import it.amichiamoci.apps.schedule.iosched.util.SelectionBuilder;
...
import it.amichiamoci.apps.schedule.iosched.Config;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.*;
import it.amichiamoci.apps.schedule.iosched.util.AccountUtils;
...
import static it.amichiamoci.apps.schedule.iosched.util.LogUtils.LOGD;
import static it.amichiamoci.apps.schedule.iosched.util.LogUtils.LOGV;
import static it.amichiamoci.apps.schedule.iosched.util.LogUtils.makeLogTag;

/**
 * Provider that stores {@link ScheduleContract} data. Data is usually inserted
 * by {@link it.amichiamoci.apps.schedule.iosched.sync.SyncHelper}, and queried by various
