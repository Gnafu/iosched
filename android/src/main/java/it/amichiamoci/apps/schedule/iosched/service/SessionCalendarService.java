...
import static it.amichiamoci.apps.schedule.iosched.util.LogUtils.LOGE;
import static it.amichiamoci.apps.schedule.iosched.util.LogUtils.LOGW;
...
public class SessionCalendarService extends IntentService {
    ...
    public static final String ACTION_ADD_SESSION_CALENDAR =
            "it.amichiamoci.apps.schedule.iosched.action.ADD_SESSION_CALENDAR";
    public static final String ACTION_REMOVE_SESSION_CALENDAR =
            "it.amichiamoci.apps.schedule.iosched.action.REMOVE_SESSION_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR =
            "it.amichiamoci.apps.schedule.iosched.action.UPDATE_ALL_SESSIONS_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR_COMPLETED =
            "it.amichiamoci.apps.schedule.iosched.action.UPDATE_CALENDAR_COMPLETED";
    public static final String ACTION_CLEAR_ALL_SESSIONS_CALENDAR =
            "it.amichiamoci.apps.schedule.iosched.action.CLEAR_ALL_SESSIONS_CALENDAR";
    public static final String EXTRA_ACCOUNT_NAME =
            "it.amichiamoci.apps.schedule.iosched.extra.ACCOUNT_NAME";
    public static final String EXTRA_SESSION_START =
            "it.amichiamoci.apps.schedule.iosched.extra.SESSION_BLOCK_START";
    public static final String EXTRA_SESSION_END =
            "it.amichiamoci.apps.schedule.iosched.extra.SESSION_BLOCK_END";
     ...
     * {@link it.amichiamoci.apps.schedule.iosched.provider.ScheduleProvider}, adding or removing
