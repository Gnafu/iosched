...
package it.amichiamoci.apps.schedule.iosched.appwidget;
...
import it.amichiamoci.apps.schedule.iosched.model.ScheduleItem;
...
import it.amichiamoci.apps.schedule.iosched.ui.SimpleSectionedListAdapter;
import it.amichiamoci.apps.schedule.iosched.ui.TaskStackBuilderProxyActivity;
import it.amichiamoci.apps.schedule.iosched.util.AccountUtils;
import it.amichiamoci.apps.schedule.iosched.util.PrefUtils;
import it.amichiamoci.apps.schedule.iosched.util.TimeUtils;
