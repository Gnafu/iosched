...
import it.amichiamoci.apps.schedule.iosched.io.model.Session;
import it.amichiamoci.apps.schedule.iosched.io.model.Speaker;
import it.amichiamoci.apps.schedule.iosched.io.model.Tag;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleDatabase;
