...
import it.amichiamoci.apps.schedule.iosched.io.map.model.MapData;
import it.amichiamoci.apps.schedule.iosched.io.map.model.MapConfig;
import it.amichiamoci.apps.schedule.iosched.io.map.model.Marker;
import it.amichiamoci.apps.schedule.iosched.io.map.model.Tile;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract;
import it.amichiamoci.apps.schedule.iosched.util.MapUtils;
