...
public class VideoLibraryActivity extends BaseActivity implements VideoLibraryFragment.Callbacks {
    ...
    private static final String STATE_KEY_YEAR = "it.amichiamoci.apps.schedule.iosched.STATE_KEY_YEAR";
    private static final String STATE_KEY_TOPIC = "it.amichiamoci.apps.schedule.iosched.STATE_KEY_TOPIC";
