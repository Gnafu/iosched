...
package it.amichiamoci.apps.schedule.iosched.sync.userdata.http;
...
import it.amichiamoci.apps.schedule.iosched.sync.userdata.UserAction;
import it.amichiamoci.apps.schedule.iosched.sync.userdata.util.UserDataHelper;
