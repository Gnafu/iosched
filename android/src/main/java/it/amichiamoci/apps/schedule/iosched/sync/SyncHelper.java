...
package it.amichiamoci.apps.schedule.iosched.sync;
...
import it.amichiamoci.apps.schedule.iosched.sync.userdata.AbstractUserDataSyncHelper;
import it.amichiamoci.apps.schedule.iosched.sync.userdata.UserDataSyncHelperFactory;
...
public class SyncHelper {
     ...
     * configured in {@link it.amichiamoci.apps.schedule.iosched.Config#MANIFEST_URL}. The remote URL
