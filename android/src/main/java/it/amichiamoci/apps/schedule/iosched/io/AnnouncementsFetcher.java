...
package it.amichiamoci.apps.schedule.iosched.io;
...
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.SyncColumns;
import it.amichiamoci.apps.schedule.iosched.util.Lists;
import it.amichiamoci.apps.schedule.iosched.util.NetUtils;
...
import static it.amichiamoci.apps.schedule.iosched.util.LogUtils.LOGI;
