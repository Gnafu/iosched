...
package it.amichiamoci.apps.schedule.iosched.ui;
...
import it.amichiamoci.apps.schedule.iosched.model.ScheduleHelper;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract;
import it.amichiamoci.apps.schedule.iosched.ui.widget.MyScheduleView;
import it.amichiamoci.apps.schedule.iosched.ui.widget.SlidingTabLayout;
import it.amichiamoci.apps.schedule.iosched.util.*;
...
public class MyScheduleActivity extends BaseActivity implements MyScheduleFragment.Listener {
    ...
    private static final String ARG_CONFERENCE_DAY_INDEX
            = "it.amichiamoci.apps.schedule.iosched.ARG_CONFERENCE_DAY_INDEX";
    ...
    public static final String EXTRA_DIALOG_TITLE
            = "it.amichiamoci.apps.schedule.iosched.EXTRA_DIALOG_TITLE";
    public static final String EXTRA_DIALOG_MESSAGE
            = "it.amichiamoci.apps.schedule.iosched.EXTRA_DIALOG_MESSAGE";
    public static final String EXTRA_DIALOG_YES
            = "it.amichiamoci.apps.schedule.iosched.EXTRA_DIALOG_YES";
    public static final String EXTRA_DIALOG_NO
            = "it.amichiamoci.apps.schedule.iosched.EXTRA_DIALOG_NO";
    public static final String EXTRA_DIALOG_URL
            = "it.amichiamoci.apps.schedule.iosched.EXTRA_DIALOG_URL";
