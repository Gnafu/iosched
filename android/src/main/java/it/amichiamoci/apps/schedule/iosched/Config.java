...
package it.amichiamoci.apps.schedule.iosched;

import android.net.Uri;

import it.amichiamoci.apps.schedule.iosched.util.ParserUtils;
...
public class Config {
    ...
    public static final String PROD_CONFERENCE_DATA_MANIFEST_URL = "http://www.amichiamoci.it/public/app2014/manifest.json";
    ...
    // Conference hashtag
    public static final String CONFERENCE_HASHTAG = "#amichiamoci2014";
    ...
    public static final String CONFERENCE_HASHTAG_PREFIX = "#amichiamoci";
    ...
    public static final long[][] CONFERENCE_DAYS = new long[][] {
            ...
            { ParserUtils.parseTime("2014-09-06T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-06T23:59:59.999Z") },
            // start and end of day 2
            { ParserUtils.parseTime("2014-09-07T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-07T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-08T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-08T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-09T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-09T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-10T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-10T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-11T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-11T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-12T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-12T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-13T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-13T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-14T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-14T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-15T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-15T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-16T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-16T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-17T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-17T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-18T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-18T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-19T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-19T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-20T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-20T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-21T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-21T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-22T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-22T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-23T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-23T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-24T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-24T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-25T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-25T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-26T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-26T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-27T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-27T23:59:59.999Z") },
            { ParserUtils.parseTime("2014-09-28T07:00:00.000Z"),
              ParserUtils.parseTime("2014-09-28T23:59:59.999Z") }
        };

    public static final TimeZone CONFERENCE_TIMEZONE = TimeZone.getTimeZone("Europe/Rome");
    ...
    public static final String APP_NAME = "Amichiamoci-2014";
