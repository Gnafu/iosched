...
package it.amichiamoci.apps.schedule.iosched.service;
...
import it.amichiamoci.apps.schedule.iosched.ui.BrowseSessionsActivity;
import it.amichiamoci.apps.schedule.iosched.ui.MapFragment;
import it.amichiamoci.apps.schedule.iosched.ui.MyScheduleActivity;
import it.amichiamoci.apps.schedule.iosched.ui.SessionFeedbackActivity;
import it.amichiamoci.apps.schedule.iosched.ui.phone.MapActivity;
import it.amichiamoci.apps.schedule.iosched.util.FeedbackUtils;
import it.amichiamoci.apps.schedule.iosched.util.PrefUtils;
import it.amichiamoci.apps.schedule.iosched.util.UIUtils;
...
public class SessionAlarmService extends IntentService
    ...
    public static final String ACTION_NOTIFY_SESSION =
            "it.amichiamoci.apps.schedule.iosched.action.NOTIFY_SESSION";
    public static final String ACTION_NOTIFY_SESSION_FEEDBACK =
            "it.amichiamoci.apps.schedule.iosched.action.NOTIFY_SESSION_FEEDBACK";
    public static final String ACTION_SCHEDULE_FEEDBACK_NOTIFICATION =
            "it.amichiamoci.apps.schedule.iosched.action.SCHEDULE_FEEDBACK_NOTIFICATION";
    public static final String ACTION_SCHEDULE_STARRED_BLOCK =
            "it.amichiamoci.apps.schedule.iosched.action.SCHEDULE_STARRED_BLOCK";
    public static final String ACTION_SCHEDULE_ALL_STARRED_BLOCKS =
            "it.amichiamoci.apps.schedule.iosched.action.SCHEDULE_ALL_STARRED_BLOCKS";
    public static final String EXTRA_SESSION_START =
            "it.amichiamoci.apps.schedule.iosched.extra.SESSION_START";
    public static final String EXTRA_SESSION_END =
            "it.amichiamoci.apps.schedule.iosched.extra.SESSION_END";
    public static final String EXTRA_SESSION_ALARM_OFFSET =
            "it.amichiamoci.apps.schedule.iosched.extra.SESSION_ALARM_OFFSET";
    public static final String EXTRA_SESSION_ID =
            "it.amichiamoci.apps.schedule.iosched.extra.SESSION_ID";
    public static final String EXTRA_SESSION_TITLE =
            "it.amichiamoci.apps.schedule.iosched.extra.SESSION_TITLE";
    public static final String EXTRA_SESSION_ROOM =
            "it.amichiamoci.apps.schedule.iosched.extra.SESSION_ROOM";
    public static final String EXTRA_SESSION_SPEAKERS =
            "it.amichiamoci.apps.schedule.iosched.extra.SESSION_SPEAKERS";
    ...
    public void scheduleFeedbackAlarm(final String sessionId, final long sessionEnd,
        ...
        feedbackIntent.setData(
                new Uri.Builder().authority("it.amichiamoci.apps.schedule.iosched")
