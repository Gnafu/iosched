...
import it.amichiamoci.apps.schedule.iosched.model.TagMetadata;
import it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract;
import it.amichiamoci.apps.schedule.iosched.service.SessionAlarmService;
import it.amichiamoci.apps.schedule.iosched.service.SessionCalendarService;
import it.amichiamoci.apps.schedule.iosched.ui.widget.CheckableFrameLayout;
import it.amichiamoci.apps.schedule.iosched.ui.widget.MessageCardView;
import it.amichiamoci.apps.schedule.iosched.ui.widget.ObservableScrollView;
...
public class SessionDetailFragment extends Fragment implements
    ...
    /**
     * {@link it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.Sessions} query parameters.
     */
