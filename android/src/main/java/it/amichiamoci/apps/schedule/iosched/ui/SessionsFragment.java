...
import static it.amichiamoci.apps.schedule.iosched.util.UIUtils.buildStyledSnippet;
...
public class SessionsFragment extends Fragment implements
    ...
    /**
     * {@link it.amichiamoci.apps.schedule.iosched.provider.ScheduleContract.Sessions}
     * query parameters.
     */
